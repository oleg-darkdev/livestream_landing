<section class="h-screen w-full ">
	<div id="header">
		<div class="headtext">
			<h1 class="text-yellow">LiveLab</h1>
			<h3 class="text-yellow">youtube live streaming</h3>
		</div>
	</div>
</section>
...
<style>
	...
	@media screen and (max-width: 767px) and (max-width: 736px) and (orientation: landscape) {
	}
</style>
